;; But they both do not support dired-up-directory, and when you go up the directory tree they put you in the top of the directory list (not like default dired that put's you on the directory name you were in) so there is one more way to achieve this.
